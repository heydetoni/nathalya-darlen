...
1. Navigate to the ["API Settings"](https://manage.sanity.io/projects/01xcwm13/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://ultra-rosemary-3b7c8.sanity.studio/.
...
Generated at `2021-03-06T17:12:26.552Z` by Stackbit version `0.3.50`.